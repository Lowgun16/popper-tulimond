...
function Carousel({ lookbook }: CarouselProps) {
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              // Mobile (handled via CSS below): full width, 100dvh, no border radius
            }}
          ...
          >
            ...
            {/* Scrollable container — carousel is sticky inside */}
            <div
              style={{
                flex: 1,
                overflowY: "auto",
            ...
            >
              ...
              {/* Scrollable product detail bottom */}
              <div
                style={{
                  paddingLeft: 24,
                  paddingRight: 24,
          ...
          {/* Panel positioning + responsive styles */}
          <style>{`
            .lookbook-panel {
              /* Desktop: 9:16 centered, max 90dvh */
              top: 50%;
